#ifndef ACROBATICDQ_H
#define ACROBATICDQ_H
...
class AcrobaticDQ final : public ModuleBase<AcrobaticDQ>, public px4::WorkItem
{
public:
    AcrobaticDQ();
    ~AcrobaticDQ() override;
    ...
    static AcrobaticDQ *instantiate(int argc, char *argv[]);
