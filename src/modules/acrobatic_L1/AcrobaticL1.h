#ifndef ACROBATICL1_H
#define ACROBATICL1_H
...
class AcrobaticL1 final : public ModuleBase<AcrobaticL1>, public px4::WorkItem
{
public:
    AcrobaticL1();
    ~AcrobaticL1() override;
    ...
    static AcrobaticL1 *instantiate(int argc, char *argv[]);
